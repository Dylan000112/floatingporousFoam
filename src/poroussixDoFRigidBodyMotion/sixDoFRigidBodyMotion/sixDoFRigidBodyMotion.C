...
:
    ...
    //total centerOfRotation
    initialCentreOfRotation_
    (dict.getOrDefault("initialCentreOfRotation",dict.get<vector>("centreOfRotation"))),
    //Rigidbody mass
    Rigidmass_
    (dict.getOrDefault("Rigidmass", dict.get<scalar>("Rigidmass"))),
    //porousmedia porosity
    myporosity_
    (dict.getOrDefault("porosity", dict.get<scalar>("porosity"))),
    //rho of porousmedia
    myrhoporo_
    (dict.getOrDefault("rhoPoro", dict.get<scalar>("rhoPoro"))),  
    //porous media size - xyz
    
    Px_
    (dict.getOrDefault("Px", dict.get<scalar>("Px"))), 
    Py_
    (dict.getOrDefault("Py", dict.get<scalar>("Py"))), 
    Pz_
    (dict.getOrDefault("Pz", dict.get<scalar>("Pz"))),        
    ...
    solver_(sixDoFSolver::New(dict.subDict("solver"), *this))
{
    ...
    //Info<< "initial CentreOfMass = " << initialCentreOfMass_ << nl << endl;
    //Info<< "initial CentreOfRotation = " << initialCentreOfRotation_ << nl << endl;
...
)
{
    ...
    else
    {
        ...
        Info<< "update acceleration" << nl << endl;
}
